                ...
                oneOf: [
                  {
                    ...
                    defaultSnippets: m.examples
                      ? // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        m.examples.map((example: any) => {
                          return {
                            label: example.name,
                            description: example.description || example.summary,
                            body:
                              example.params && example.params.map((ex: ExampleObject) => ex.value),
                          };
                        })
                      : [],
                    items:
                  ...
                  },
                  {
                    ...
                    properties:
                      m.params &&
                      (m.params as ContentDescriptorObject[]).reduce(
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
